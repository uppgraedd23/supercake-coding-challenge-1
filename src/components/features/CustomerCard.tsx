    ...
    return (
      <div className="bg-card p-4">
        <div className="flex flex-col sm:flex-row sm:flex-wrap lg:grid lg:grid-cols-[200px_minmax(200px,1fr)_150px_1fr] gap-3 sm:gap-4 lg:gap-6 items-start sm:items-center">
          <div className="font-semibold text-text w-full sm:w-auto lg:truncate">
            {customer.name}
          </div>
          <div className="text-sm text-text-secondary w-full sm:flex-1 lg:truncate break-words sm:break-normal">
            {customer.email}
          </div>
          <div className="text-sm text-text-secondary w-full sm:w-auto">
            {customer.phone || "-"}
          </div>
